defmodule ExLingo.Translations.Locale.Finders.ListLocalesWithTranslatedMessage do
  @moduledoc """
  ...
  alias ExLingo.Translations.{Locale, Message, PluralTranslation, SingularTranslation}

defmodule ExLingo.Migrations.SQLite3.V01 do
  @moduledoc """
  ExLingo SQLite3 V1 Migrations
  """
  ...
  defp up_messages(_opts) do
    ...
    execute "ALTER TABLE #{@ex_lingo_messages} ADD COLUMN searchable TEXT AS (msgid) VIRTUAL"
  ...
  defp up_singular_translations(_opts) do
    ...
    execute "ALTER TABLE #{@ex_lingo_singular_translations} ADD COLUMN searchable TEXT AS (translated_text) VIRTUAL"
  end
  ...
  defp up_plural_translations(_opts) do
    ...
    execute "ALTER TABLE #{@ex_lingo_plural_translations} ADD COLUMN searchable TEXT AS (translated_text) VIRTUAL"
  end

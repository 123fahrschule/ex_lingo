defmodule ExLingo.Query do
  @moduledoc """
    ...
    ```
    use ExLingo.Query,
      module: ExLingo.ResourceModuleGoesHere,
  ...
  defmacro __using__(opts \\ []) do
    ...
    quote do
      ...
      #
      # iex> base()
      # #Ecto.Query<from u0 in ExLingo.Accounts.User, as: :user
      #
      ...
      ## Examples
          ...
          iex> ExLingo.Accounts.UserQueries.unique()
          #Ecto.Query<from u0 in ExLingo.Accounts.User, as: :user, distinct: true>
      """
      ...
      ## Examples
          ...
          iex> ExLingo.Accounts.UserQueries.select_column(:email)
          #Ecto.Query<from u0 in ExLingo.Accounts.User, as: :user, select: u0.email>
      """
      ...
      ## Examples
          ...
          iex> ExLingo.Accounts.UserQueries.preload_resources(:articles)
          #Ecto.Query<from u0 in ExLingo.Accounts.User, as: :user,
            preload: [[:articles]]>
      """
      ...
      ## Examples
          ...
          iex> ExLingo.Accounts.UserQueries.count(:email)
          #Ecto.Query<from u0 in ExLingo.Accounts.User, as: :user,
      ...
      *Important!* The joining has to be defined by join_resource/3 function. Example:
      ...
      ## Examples
          ...
          iex> ExLingo.Accounts.UserQueries.with_join(:articles)
          #Ecto.Query<from u0 in ExLingo.Accounts.User, as: :user,
      ...
      ## Examples
          ...
          iex> ExLingo.Accounts.UserQueries.filter_query(%{"email" => "a@a.com"})
          #Ecto.Query<from u0 in ExLingo.Accounts.User, as: :user, where: u0.email == ^"a@a.com">
      """
      ...
      ## Examples
          ...
          iex> ExLingo.Accounts.UserQueries.search_query("some text")
          #Ecto.Query<from u0 in ExLingo.Accounts.User, where: fragment("to_tsvector(?::text) @@ plainto_tsquery(?)", u0, ^"some text")>
      """

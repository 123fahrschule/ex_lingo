defmodule ExLingo.Backend.Adapter.CachedDB do
  @moduledoc """
  ExLingo adapter used in *gettext functions from ExLingo.Gettext.Macros.
  ...
  defp apply_bindings(text, bindings) do
    case Gettext.Interpolation.Default.runtime_interpolate(text, bindings) do
      ...
      {:missing_bindings, partially_interpolated_message, missing_bindings} ->
        Logger.warning("[ExLingo]: Missing bindings for translation", %{
          text: text,

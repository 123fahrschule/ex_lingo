defmodule ExLingo.Config do
  @moduledoc """
  ExLingo configuration helper
  """
  @type t :: %__MODULE__{
          name: atom(),
          otp_name: atom(),
  ...
  alias ExLingo.Validator

  @doc """
  Generate a Config struct after normalizing and verifying ExLingo options.

  See `ExLingo.start_link/1` for a comprehensive description of available options.

  ## Example

  Generate a minimal config with only a `:repo`:

      ExLingo.Config.new(repo: ExLingo.Test.Repo)
  """

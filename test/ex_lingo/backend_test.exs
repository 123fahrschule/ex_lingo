defmodule ExLingo.BackendTest do
  require Logger
  ...
  defmodule Backend do
    use ExLingo.Backend, otp_app: :ex_lingo, priv: "test/fixtures/single_messages"
  end

  alias ExLingo.BackendTest.Backend
